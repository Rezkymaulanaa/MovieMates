...
public class ToyStory extends NotifBookmark{
    private Stage stage;
    ...
    public void show(){
        ...
        buttontonton.setOnAction(e -> {
            try {
                String url = "https://77.105.142.75/movie/toy-story-4-2019/";
        ...
        if (Bookmark.ListBookmark.contains("images/Poster_ToyStory4.jpg")){
            buttonbookmark.setStyle("-fx-background-color: #C2C2C2; -fx-font-weight: bold");
        }
        buttonbookmark.setOnAction(event -> {
            if (!Bookmark.ListBookmark.contains("images/Poster_ToyStory4.jpg")){
            Bookmark.ListBookmark.add("images/Poster_ToyStory4.jpg");
            buttonbookmark.setStyle("-fx-background-color: #C2C2C2; -fx-font-weight: bold");
            notifShow();}
            else{Bookmark.ListBookmark.remove("images/Poster_ToyStory4.jpg");
            buttonbookmark.setStyle("-fx-background-color: #F8F8F8; -fx-font-weight: bold");
            notifRemove();
            }
        });
