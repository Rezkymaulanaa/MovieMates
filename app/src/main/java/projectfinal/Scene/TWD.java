...
public class TWD extends NotifBookmark{
    private Stage stage;
    ...
    public void show(){
        ...
        if (Bookmark.ListBookmark.contains("images/Poster_The_Walking_Dead.jpg")){
            buttonbookmark.setStyle("-fx-background-color: #C2C2C2; -fx-font-weight: bold");
        }
        buttonbookmark.setOnAction(event -> {
            if (!Bookmark.ListBookmark.contains("images/Poster_The_Walking_Dead.jpg")){
            Bookmark.ListBookmark.add("images/Poster_The_Walking_Dead.jpg");
            buttonbookmark.setStyle("-fx-background-color: #C2C2C2; -fx-font-weight: bold");
            notifShow();}
            else{Bookmark.ListBookmark.remove("images/Poster_The_Walking_Dead.jpg");
            buttonbookmark.setStyle("-fx-background-color: #F8F8F8; -fx-font-weight: bold");
            }
        });
